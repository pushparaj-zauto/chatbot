...
const TeamMemberOffCanvas = ({
  ...
  return (
    ...
    >
      <div
        className={`fixed top-0 right-0 h-full bg-bgColor w-full max-w-md transform transition-transform z-60 ${
        ...
        <div className="flex flex-col h-full">
          <div className="bg-navBgColor px-6 py-4 border-b border-borderColor flex items-center justify-between">
            <h3 className="text-lg font-semibold text-textPrimary flex items-center gap-2">
              {selectedUser ? <User className="w-5 h-5" /> : <User className="w-5 h-5" />}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
            <div>
              <label className="block text-sm font-medium text-textPrimary mb-1">
                Name <span className="text-red-700 dark:text-red-500 mx-1">*</span>
              </label>
              <input
                type="text"
                name="name"
            ...
            <div>
              <label className="block text-sm font-medium text-textPrimary mb-1">
                Email <span className="text-red-700 dark:text-red-500 mx-1">*</span>
              </label>
              <input
                type="email"
                name="email"
            ...
            {!selectedUser && (
              <div>
                <label className="block text-sm font-medium text-textPrimary mb-1">
                  Password <span className="text-red-700 dark:text-red-500 mx-1">*</span>
                </label>
                <input
                  type="password"
                  name="password"
            ...
            <div>
              <label className="block text-sm font-medium text-textPrimary mb-1">Mobile</label>
              <input
                type="text"
                name="mobile"
              ...
              />
              {errors.mobile && <p className="text-danger text-xs mt-1">{errors.mobile}</p>}
            </div>

            <div>
              <label className="block text-sm font-medium text-textPrimary mb-1">WhatsApp</label>
              <input
                type="text"
                name="whatsapp"
            ...
            <div>
              <label className="block text-sm font-medium text-textPrimary mb-1">
                Role <span className="text-red-700 dark:text-red-500 mx-1">*</span>
              </label>
              <select
                name="role"
                value={formData.role}
